...
export default class Order {
    ...
    constructor(readonly idOrder: string | undefined, cpf: string, readonly currencyTable: CurrencyTable = new CurrencyTable(),
        readonly sequence: number = 1, readonly date: Date = new Date()) {
        if (!this.idOrder) this.idOrder = crypto.randomUUID();
        this.items = [];
