...
insert into cccat10.product (id_product, description, price, width, height, length, weight, currency) values (3, 'C', 30, 30, 10, 10, 0.9, 'BRL');
...
insert into cccat10.product (id_product, description, price, width, height, length, weight, currency) values (5, 'E', 1000, 100, 30, 10, 3, 'USD');
...
insert into cccat10.coupon (code, percentage, expired_date) values ('VALE20', 20, '2023-10-01T10:00:00');
insert into cccat10.coupon (code, percentage, expired_date) values ('VALE10', 10, '2022-10-01T10:00:00');
